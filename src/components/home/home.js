...
const Home = () => {
  ...
  const FeaturedEvents =
    ticketEvents.length >= 6 ? ticketEvents.slice(0, 6) : ticketEvents;

  const upcomingEvents =
    ticketEvents.length >= 12 ? ticketEvents.slice(0, 12) : ticketEvents;
      ...
      <div className="home">
        <div className="container-fluid text-center intro">
          <div className=" row mb-5 p-5 pb-5 ">
            <div
              className="col-sm-6 col-lg-6 col-xl-6 col-xs-12"
              data-aos="fade-up"
            >
              <div className="m-5 p-5 ">
                <h1 className=" nearest-event mb-4">
                  Looking for your nearest event?
                </h1>
            ...
            >
              <div className="intro-image p-5">
                <img src={require("../../images/party.jpg")} alt="intro" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            {FeaturedEvents.map((event) => {
              if (
                ...
                return (
                  <div
                    className="col-sm-4 col-lg-4 col-xl-4 col-xs-12 "
                      ...
                      <div className="card">
                        ...
                        <div className="row card-body">
                          <div className="col-8 title ">
                            <h5 className=" float-left">{event.title}</h5>{" "}
                          </div>
                          <div className="col-4 ">
                    ...
                    <div>
                      <h5>
                        <i>
                          ...
                          vitae, pretium mattis, nunc. Mauris eget neque at sem
